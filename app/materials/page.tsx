...
const faq = [
  ...
  { question: "Что делать, если нужного отчёта нет?", answer: "Библиотека будет пополняться. Специфический отчёт или полноценную систему можно разработать под процессы вашей компании." },
